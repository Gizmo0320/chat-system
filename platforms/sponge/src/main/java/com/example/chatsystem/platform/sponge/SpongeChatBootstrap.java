package com.example.chatsystem.platform.sponge;
...
/**
 * Sponge adapter entry point that wires platform chat events into the shared chat system.
 */
public final class SpongeChatBootstrap {
    private final ChatSystem chatSystem;
    private final PlatformChatHandler chatHandler;
    private final AdminCommandHandler adminCommandHandler;

    public SpongeChatBootstrap(ChatSystem chatSystem, PlatformChatHandler chatHandler) {
    ...
    public void onChat(String channelId, UUID senderId, String senderName, String content) {
        ChatMessage message = new ChatMessage(senderId, senderName, content, Instant.now(), "sponge");
